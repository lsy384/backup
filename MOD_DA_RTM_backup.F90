...
!-----------------------------------------------------------------------
      ...
      ! ! 根据 forward 子程序，表层主要由前两层组成，厚度为 0.0175 + 0.0276 = 0.0451 m
      ! CALL eff_soil_temp_Lv(0.0451_r8, t_surf, t_deep, eps_soil, t_eff)
      ! 确保 t_soi 传入的是开尔文 (K)，并且 wc_soi 为 m3/m3，wf_clay 为 % 百分比
